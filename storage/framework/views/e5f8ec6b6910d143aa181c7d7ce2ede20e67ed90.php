                    ...
                    <div class="card-body box-profile">
                      ...
                      <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                          <b>NISN</b> <a class="float-right"><?php echo e($user->nisn); ?></a>
                        </li>
                        <li class="list-group-item">
                    ...
                    <div class="card">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <h6>Tahun Masuk :</h6>
                                            <?php if($user->tahun_masuk): ?>
                                                <p><?php echo e($user->tahun_masuk); ?></p>
                                            <?php else: ?>
                                                <p>Kosong...</p>
                                            <?php endif; ?>
                                        </div>
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" method="post" action="/Student/Profile/<?php echo e($user->id); ?>">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="nisn" type="text" class="form-control" placeholder="Nomor NISN" value="<?php echo e($user->nisn); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" disabled class="form-control" value="<?php echo e($user->kelas); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input disabled type="text" class="form-control" value="<?php echo e($user->tahun_masuk); ?>">
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="password">
                                ...
                                <!-- End of Success And Fail/Error Alert -->
                                <form class="form-horizontal" method="post" action="/Student/Profile/changePassword/<?php echo e($user->id); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Oranta19\LaraELearn\resources\views/pages/Student/profile/profilePage.blade.php ENDPATH**/ ?>